...
class TranslatorAppGUI(ctk.CTk):
    ...
    def create_widgets(self):
        ...
        self.radio_voice = ctk.CTkRadioButton(self, text= "Voice Input", vairiable= self.input_choice_var, value= "voice", font= ("Rockwell Regular", 18))
        self.radio_voice.pack(pady=10)

        self.radio_text = ctk.CTkRadioButton(self, text="Text Input", vairalbe= self.input_choice_var, value="text", font=("Rockwell Regular", 18))
